...
const LoadingScreen = () => {
  return (
    <div className="full-center" style={{ background: 'radial-gradient(circle at 20% 20%, #1e3a5f 0%, #0f172a 45%, #020617 85%)', zIndex: 50, position: 'fixed', top: 0, left: 0 }}>
      ...
      {/* Overlay Content */}
      <div style={{ zIndex: 10, display: 'flex', flexDirection: 'column', alignItems: 'center', pointerEvents: 'none', background: 'rgba(17,24,39,0.92)', padding: '28px 56px', borderRadius: '16px', border: '1px solid var(--border-color)', backdropFilter: 'blur(12px)', boxShadow: 'var(--shadow-lg)' }}>
        <h1 style={{ fontSize: '2.6rem', marginBottom: '8px', color: '#f1f5f9', letterSpacing: '-1px' }}>
          Walle-T
        </h1>
        <p style={{ marginBottom: 16, color: '#94a3b8', fontWeight: 600 }}>Market intelligence terminal is booting...</p>
        <div style={{ width: 220, height: 6, background: '#334155', borderRadius: 999, overflow: 'hidden', marginBottom: 14 }}>
